...
public class vessel_main extends SherlockActivity {
	...
	private String[] vessel_list = { "Current List", "Vessel Profile List",
			...
			"Berth Request/Allotment", "Dangerous Goods Ack",
			"Un-Berthing/ Re-Berthing", "Resourse Requisition/Allotment",
			"Stowage Plan", "Terminal Performance Report",
			"Stowage Instruction", "Bay Plan", "Vessel Movement", "Pilot Memo",
			"Pre-Arrival", "MMD Inspection", "PHO", "Expected Timings",
			"Change of Agency", "Stowage Plan for Cargo" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_1, vessel_list);
		...
		v.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
				...
				if (g.toString().equals("Current List")) {

					Intent i = new Intent();
					i.setClass(vessel_main.this, CurrentList.class);
